...
extern  SPI_HandleTypeDef hspi; //this variable is declared in es_wifi_io
...
int main(void)
{
  ...
  LogLine("");
  LogLine("Board initialized");

  LogLine("Initializing WiFi Module");
...
int wifi_start(void)
{
	...
	if (WIFI_Init() == WIFI_STATUS_OK)
	{
		...
		{
			LogLine(("ERROR : CANNOT get MAC address\n"));
			return -1;
		}
	}
	else
